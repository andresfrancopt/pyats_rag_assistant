...
and uses Ollama's local LLM API to provide detailed analysis of network configurations.
...
Environment variables supported:
    ...
    OLLAMA_TOP_P: Top-p setting (default: 0.8)
    OLLAMA_TOP_K: Top-k setting (default: 50)
...
OLLAMA_CONFIG = {
    ...
    "top_k": int(os.getenv("OLLAMA_TOP_K", "50"))
}
...
def main():
    ...
    while True:
        ...
        try:
            ...
            # Prepare the request for Ollama API using the original prompt structure
            payload = {
