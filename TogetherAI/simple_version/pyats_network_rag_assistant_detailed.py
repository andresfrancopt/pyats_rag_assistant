...
def get_context_and_query(retriever, question: str) -> str:
    """Get context and create query with improved context handling."""
    ...
    - Relevant Configuration:
      ...
      * [additional context or recommendations if relevant]

    ### In-a-nutshell:
    - [concise bullet points summarizing key findings]
    - [critical implications or recommendations]
    - [overall assessment]
    """
